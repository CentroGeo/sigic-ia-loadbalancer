...
def chatear(context):
    ...
    try:
        ...
        url = "http://10.2.13.44:8000/start" #ip de mi local
...
def health(uuid):
    try:
        url = "http://10.2.13.44:8000/process/"+uuid #ip de mi local
...
if __name__ == '__main__':   
    ...
    try:
        ...
        #answer_str2 = answer_str.replace("json", "")
        #answer_json = json.loads(answer_str2)
    except:
        answer_json = {}
        print("error")
